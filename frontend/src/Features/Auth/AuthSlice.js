...
const initialState = {
  loading: false,
  userInfo: 
    Cookies.get('converselyLoggedInUser')
    ? 
    { token: Cookies.get('converselyLoggedInUserToken') }
    : null,
  error: null,
  success: null,
  message: null,
    ...
    extraReducers: (builder) => {
        ...
        .addCase(userLogin.fulfilled, (state, { payload }) => {
            ...
            if (payload.data.token) {
                ...
                // Cookies.set('converselyLoggedInUser',JSON.stringify(decodedData), { expires: 7 })
                Cookies.set('converselyLoggedInUserToken',payload.data.token, { expires: 7 })
        ...
        .addCase(userLogout.fulfilled, (state, { payload }) => {
            Cookies.remove('converselyLoggedInUser')
